...
export default function App({ user, logOut }) {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case 'budget':
        return <BudgetPage budgets={budgets} addBudget={addBudget} updateBudget={updateBudget} removeBudget={removeBudget} stats={stats} />
      case 'accounts':
        return <AccountsPage accounts={accounts} addAccount={addAccount} updateAccount={updateAccount} removeAccount={removeAccount} />
      case 'investments':
        return <InvestmentsPage investments={investments} addInvestment={addInvestment} updateInvestment={updateInvestment} removeInvestment={removeInvestment} accounts={accounts} />
      case 'bills':
        return <BillsPage bills={bills} addBill={addBill} updateBill={updateBill} removeBill={removeBill} />
      case 'reports':
        return <ReportsPage transactions={transactions} accounts={accounts} budgets={budgets} stats={stats} />
      case 'settings':
